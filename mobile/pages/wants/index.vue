  ...
  methods: {
    async fetchWants() {
      ...
      try {
        ...
        const res = await get('/api/wants', params)
...
.search-btn { background: linear-gradient(135deg, #0d9488, #14b8a6); color: #fff; padding: 0 16px; border-radius: 8px; line-height: 40px; font-size: 14px; white-space: nowrap; }
